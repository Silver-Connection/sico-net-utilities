namespace SiCo.Utilities.Generics
{
    ...
    public static class FileLogger
    {
        ...
        /// <param name="cancellationToken"></param>
        /// </summary>
        public static async Task JsonAsync(object model, CancellationToken cancellationToken = default(CancellationToken))
        {
            string msg = JsonConvert.SerializeObject(model, Formatting.Indented);
            await WriteAsync(msg, model.GetType(), cancellationToken);
        }
